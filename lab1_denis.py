...
my_name = "Denis" # Change to your name
my_github_account = "https://github.com/ilnegozio/comp115" # Change to your GitHub account
my_hobby = "driving" # Change to your hobby
hours_coding_per_week = "4" # How many hours per week would you like to devote to learn coding?
...
project_interested = project_types[3]
project_another_interested = project_types[2] # Try to change the index from 3 to 4, and run the program :)
