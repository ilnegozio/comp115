...
def draw_square(side_length):
    ...
    for x in range(4):
        pen.forward(side_length) # Complete the function body
        pen.left(exterior_angle)
    pen.shape("blank")
    pen.clear()
...
def draw_regular_polygon(num_sides, side_length):
    ...
    for x in range(num_sides):
        pen.backward(side_length)
        pen.right(exterior_angle)
    pen.shape("blank")
    pen.clear()


draw_regular_polygon(8, 100)
...
def draw_circles(num_circles):
    ...
    for x in range(num_circles):
        radius = radius + (radius_increase * x)
        pen.circle(radius)
    pen.shape("blank")
    pen.clear()
...
def draw_concentric_circles(num_circles):
    ...
    for x in range(num_circles):
        pen.down()
        radius = radius + (radius_increase * x) # updated radius
        pen.circle(radius)
        pen.up()
        pen.right(90)
        move = radius_increase * (x + 1)
        pen.forward(move)
        pen.left(90)
    pen.shape("blank")
    #pen.clear()
